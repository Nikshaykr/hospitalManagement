...
import com.learningspringboot.hospitalManagement.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.learningspringboot.hospitalManagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
